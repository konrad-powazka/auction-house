// This is angular-ui-bootstrap-datetimepicker v2.0.2 package with a validation bug fixed
            ...
            link: function (scope, element, attrs, ctrl) {
                ...
                scope.$watch(function () {
                    ...
                    if (!angular.isUndefined(errors)) {
                        // old errors need to be cleared before applying new ones:
                        Object.keys(oldErrors)
                            .forEach(function(oldError) {
                                ctrl.$setValidity(oldError, true);
                            });
                    }
          ...
          link: function (scope, elm, attrs, ctrl) {
              ...
              var isolatedFormCtrl = {
                  $setValidity: function (validationToken, isValid, control) {
                      ...
                      parent.$setValidity(validationToken, isValid, ctrl);
                  }
              };
